...
namespace WDBXLib.FileTypes
{
    public class WDB5 : DBHeader
    {
        ...
        #region Write
        public override void WriteHeader<T>(BinaryWriter bw, DBFile<T> entry)
        {
        ...
        public override void WriteOffsetMap<T>(BinaryWriter bw, DBFile<T> entry, List<Tuple<int, short>> OffsetMap)
        {
        ...
        public override void WriteIndexTable<T>(BinaryWriter bw, DBFile<T> entry)
        {
            int m = 0;
            int[] ids;
        ...
        public void WriteCopyTable<T>(BinaryWriter bw, DBFile<T> entry)
        {
        ...
        public override void WriteRecordPadding<T>(BinaryWriter bw, DBFile<T> entry, long offset)
        {
            if (HasOffsetTable)
