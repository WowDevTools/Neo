...
namespace WDBXLib.Structures
{
    ...
    public class ChrRacesEntry
    {
        ...
        public int ExplorationSoundId;             // 3
        public int ModelM;                         // 4
        public int ModelF;                         // 5
        public string ClientPrefix;                 // 6
        public int BaseLanguage;                   // 7
        public int CreatureType;                   // 8
        public int ResSicknessSpellId;             // 9
        public int SplashSoundId;                  // 10
        public string ClientFileString;             // 11
        public int CinematicSequenceId;            // 12
        public int Alliance;                       // 13
        ...
        public int RequiredExpansion;              // 68
