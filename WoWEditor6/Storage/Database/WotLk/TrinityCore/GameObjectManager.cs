        ...
        public void LoadGameObjects(DataTable pDataTable)
        {
            foreach (DataRow dRow in pDataTable.Rows)
            {
                var gameobject = new GameObject()
                {
                    ...
                    QuestItem1 = int.Parse(dRow[10].ToString()),
                    QuestItem2 = int.Parse(dRow[11].ToString()),
                    QuestItem3 = int.Parse(dRow[12].ToString()),
                    QuestItem4 = int.Parse(dRow[13].ToString()),
                    QuestItem5 = int.Parse(dRow[14].ToString()),
                    QuestItem6 = int.Parse(dRow[15].ToString()),
                    Data0 = int.Parse(dRow[16].ToString()),
                    Data1 = int.Parse(dRow[17].ToString()),
                    Data2 = int.Parse(dRow[18].ToString()),
                    Data3 = int.Parse(dRow[19].ToString()),
                    Data4 = int.Parse(dRow[20].ToString()),
                    Data5 = int.Parse(dRow[21].ToString()),
                    Data6 = int.Parse(dRow[22].ToString()),
                    Data7 = int.Parse(dRow[23].ToString()),
                    Data8 = int.Parse(dRow[24].ToString()),
                    Data9 = int.Parse(dRow[25].ToString()),
                    Data10 = int.Parse(dRow[26].ToString()),
                    Data11 = int.Parse(dRow[27].ToString()),
                    Data12 = int.Parse(dRow[28].ToString()),
                    Data13 = int.Parse(dRow[29].ToString()),
                    Data14 = int.Parse(dRow[30].ToString()),
                    Data15 = int.Parse(dRow[31].ToString()),
                    Data16 = int.Parse(dRow[32].ToString()),
                    Data17 = int.Parse(dRow[33].ToString()),
                    Data18 = int.Parse(dRow[34].ToString()),
                    Data19 = int.Parse(dRow[35].ToString()),
                    Data20 = int.Parse(dRow[36].ToString()),
                    Data21 = int.Parse(dRow[37].ToString()),
                    Data22 = int.Parse(dRow[38].ToString()),
                    Data23 = int.Parse(dRow[39].ToString()),
                    AiName = dRow[40].ToString(),
                    ScriptName = dRow[41].ToString(),
                    VerifiedBuild = int.Parse(dRow[42].ToString())
                };
