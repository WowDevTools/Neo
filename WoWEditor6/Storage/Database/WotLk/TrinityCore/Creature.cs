...
namespace WoWEditor6.Storage.Database.WotLk.TrinityCore
{
    class Creature : ICreature
    {
        ...
        {
            // TODO
            return "UPDATE creature_template SET difficulty_entry_1 = '" + this.DifficultyEntry1 + "', difficulty_entry_2 = '" + this.DifficultyEntry2 + "', difficulty_entry_3 = '" + this.DifficultyEntry3 + "', KillCredit1 = '" + this.KillCredit1 + "', KillCredit2 = '" + this.KillCredit2 + "', modelid1 = '" + this.ModelId1 + "', modelid2 = '" + this.ModelId2 + "', modelid3 = '" + this.ModelId3 + "', modelid4 = '" + this.ModelId4 + "', name = '" + this.Name + "', subname = '" + this.SubName + "', IconName = '" + this.IconName + "', gossip_menu_id = '" + this.GossipMenuId + "', minlevel = '" + this.MinLevel + "', maxlevel = '" + this.MaxLevel + "', exp = '" + this.Experience + "', faction = '" + this.Faction + "', npcflag = '" + this.NpcFlag + "', speed_walk = '" + this.SpeedWalk + "', speed_run = '" + this.SpeedRun + "', scale = '" + this.Scale + "', rank = '" + this.Rank + "', dmgschool = '" + this.DamageSchool + "', BaseAttackTime = '" + this.BaseAttackTime + "', RangeAttackTime = '" + this.RangeAttackTime + "', BaseVariance = '" + this.BaseVariance + "', RangeVariance = '" + this.RangeVariance + "', unit_class = '" + this.UnitClass + "', unit_flags = '" + this.UnitFlags + "', unit_flags2 = '" + this.UnitFlags2 + "', dynamicflags = '" + this.DynamicFlags + "', family = '" + this.Family + "', trainer_type = '" + this.TrainerType + "', trainer_spell = '" + this.TrainerSpell + "', trainer_class = '" + this.TrainerClass + "', trainer_race = '" + this.TrainerRace + "', type = '" + this.Type + "', type_flags = '" + this.TypeFlags + "', lootid = '" + this.LootId + "', pickpocketloot = '" + this.PickPocketLoot + "', skinloot = '" + this.SkinLoot + "', resistance1 = '" + this.Resistance1 + "', resistance2 = '" + this.Resistance2 + "', resistance3 = '" + this.Resistance3 + "', resistance4 = '" + this.Resistance4 + "', resistance5 = '" + this.Resistance5 + "', resistance6 = '" + this.Resistance6 + "', spell1 = '" + this.Spell1 + "', spell2 = '" + this.Spell2 + "', spell3 = '" + this.Spell3 + "', spell4 = '" + this.Spell4 + "', spell5 = '" + this.Spell5 + "', spell6 = '" + this.Spell6 + "', spell7 = '" + this.Spell7 + "', spell8 = '" + this.Spell8 + "', PetSpellDataId = '" + this.PetSpellDataId + "', VehicleId = '" + this.VehicleId + "', mingold = '" + this.MinGold + "', maxgold = '" + this.MaxGold + "', AIName = '" + this.AiName + "', MovementType = '" + this.MovementType + "', InhabitType = '" + this.InhabitType + "', HoverHeight = '" + this.HoverHeight + "', HealthModifier = '" + this.HealthModifier + "', ManaModifier = '" + this.ManaModifier + "', ArmorModifier = '" + this.ArmorModifier + "', DamageModifier = '" + this.DamageModifier + "', ExperienceModifier = '" + this.ExperienceModifier + "', RacialLeader = '" + this.RacialLeader + "', questItem1 = '" + this.QuestItem1 + "', questItem2 = '" + this.QuestItem2 + "', questItem3 = '" + this.QuestItem3 + "', questItem4 = '" + this.QuestItem4 + "', questItem5 = '" + this.QuestItem5 + "', questItem6 = '" + this.QuestItem6 + "', movementId = '" + this.MovementId + "', RegenHealth = '" + this.RegenHealth + "', mechanic_immune_mask = '" + this.MechanicImmuneMask + "', flags_extra = '" + this.FlagsExtra + "', ScriptName = '" + this.ScriptName + "', VerifiedBuild = '" + this.VerifiedBuild + "' WHERE entry = '" + this.EntryId + "';";
        }

        public string GetInsertSqlQuery()
        {
            return "INSERT INTO creature_template VALUES ('" + this.EntryId + "', '" + this.DifficultyEntry1 + "', '" + this.DifficultyEntry2 + "', '" + this.DifficultyEntry3 + "', '" + this.KillCredit1 + "', '" + this.KillCredit2 + "', '" + this.ModelId1 + "', '" + this.ModelId2 + "', '" + this.ModelId3 + "', '" + this.ModelId4 + "', '" + this.Name + "', " + this.SubName + ", " + this.IconName + ", '" + this.GossipMenuId + "', '" + this.MinLevel + "', '" + this.MaxLevel + "', '" + this.Experience + "', '" + this.Faction + "', '" + this.NpcFlag + "', '" + this.SpeedWalk + "', '" + this.SpeedRun + "', '" + this.Scale + "', '" + this.Rank + "', '" + this.DamageSchool + "', '" + this.BaseAttackTime + "', '" + this.RangeAttackTime + "', '" + this.BaseVariance + "', '" + this.RangeVariance + "', '" + this.UnitClass + "', '" + this.UnitFlags + "', '" + this.UnitFlags2 + "', '" + this.DynamicFlags + "', '" + this.Family + "', '" + this.TrainerType + "', '" + this.TrainerSpell + "', '" + this.TrainerClass + "', '" + this.TrainerRace + "', '" + this.Type + "', '" + this.TypeFlags + "', '" + this.LootId + "', '" + this.PickPocketLoot + "', '" + this.SkinLoot + "', '" + this.Resistance1 + "', '" + this.Resistance2 + "', '" + this.Resistance3 + "', '" + this.Resistance4 + "', '" + this.Resistance5 + "', '" + this.Resistance6 + "', '" + this.Spell1 + "', '" + this.Spell2 + "', '" + this.Spell3 + "', '" + this.Spell4 + "', '" + this.Spell5 + "', '" + this.Spell6 + "', '" + this.Spell7 + "', '" + this.Spell8 + "', '" + this.PetSpellDataId + "', '" + this.VehicleId + "', '" + this.MinGold + "', '" + this.MaxGold + "', '" + this.AiName + "', '" + this.MovementType + "', '" + this.InhabitType + "', '" + this.HoverHeight + "', '" + this.HealthModifier + "', '" + this.ManaModifier + "', '" + this.ArmorModifier + "', '" + this.DamageModifier + "', '" + this.ExperienceModifier + "', '" + this.RacialLeader + "', '" + this.QuestItem1 + "', '" + this.QuestItem2 + "', '" + this.QuestItem3 + "', '" + this.QuestItem4 + "', '" + this.QuestItem5 + "', '" + this.QuestItem6 + "', '" + this.MovementId + "', '" + this.RegenHealth + "', '" + this.MechanicImmuneMask + "', '" + this.FlagsExtra + "', '" + this.ScriptName + "', '" + this.VerifiedBuild + "');";
        }
    }
}
