        ...
        public void LoadItem(DataTable pDataTable)
        {
            ...
            foreach (DataRow dRow in pDataTable.Rows)
            {
                var item = new Item()
                {
                    ...
                    BuyPrice = int.Parse(dRow[10].ToString()),
                    SellPrice = int.Parse(dRow[11].ToString()),
                    ...
                    dmg_min1 = int.Parse(dRow[50].ToString()),
                    dmg_max1 = int.Parse(dRow[51].ToString()),
                    dmg_type1 = (itemDmgType)Enum.Parse(typeof(itemDmgType), dRow[52].ToString()),
                    dmg_min2 = int.Parse(dRow[53].ToString()),
                    dmg_max2 = int.Parse(dRow[54].ToString()),
                    ...
                    RangedModRange = int.Parse(dRow[65].ToString()),
                    ...
                    spellppmRate_1 = int.Parse(dRow[69].ToString()),
                    ...
                    spellppmRate_2 = int.Parse(dRow[76].ToString()),
                    ...
                    spellppmRate_3 = int.Parse(dRow[83].ToString()),
                    ...
                    spellppmRate_4 = int.Parse(dRow[90].ToString()),
                    ...
                    spellppmRate_5 = int.Parse(dRow[97].ToString()),
                    ...
                    description = int.Parse(dRow[102].ToString()),
